...
$(function(){
    $('.Shopping_Cart').mousemove(function(){
        $('#cus-spc').css('display','block');
        $('#an_icon').css('display','none');

    })
    $('.Shopping_Cart').mouseleave(function(){
        $('#cus-spc').css('display','none');
        $('#an_icon').css('display','block');
    })
    $('.model_login').mousemove(function(){
        $('#cus-lg').css('display','block');
        $('#an_icon_lg').css('display','none');

    })
    $('.model_login').mouseleave(function(){
        $('#cus-lg').css('display','none');
        $('#an_icon_lg').css('display','block');
    })
    $('.model_signin').mousemove(function(){
        $('#cus-sg').css('display','block');
        $('#an_icon_sg').css('display','none');

    })
    $('.model_signin').mouseleave(function(){
        $('#cus-sg').css('display','none');
        $('#an_icon_sg').css('display','block');
    })
})
